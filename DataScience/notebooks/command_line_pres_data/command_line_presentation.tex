...
\documentclass{article}
    ...
    \title{Data Analysis on the Command Line \\
        \tiny{Loosely based on the Jeroen Janssens Book \\
...
\makeatother
    ...
    \section{Command Line Tools for Small
Data}\label{command-line-tools-for-small-data}
...
combing it with grep / pcregrep can be enough to get a report out.

I also find myself loading data into a table on mySQL as the size of the
